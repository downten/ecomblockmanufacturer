<?php
/*
*  @author Jason <jaskevs@gmail..com>
*  @copyright  2007-2015 thinkeCommerce
*  @version  1.1
*  @license    http://opensource.org/licenses/osl-3.0.php  Open Software License (OSL 3.0)
*  @developed by jaiosn by customizing core block manufacturer module, 
*  @developed at Gmt Lighting for its ecommerce portal @ lightonline.com.au
*  @feel free to use these codes as you need
*/

if (!defined('_PS_VERSION_'))
	exit;

class EcomBlockManufacturer extends Module {
    ...
    {
    	$this->name = 'ecomblockmanufacturer';
        ...
        $this->bootstrap = true;
		parent::__construct();
        $this->_prefix = 'ecom_manuf';	

		$this->displayName = $this->l('eCommerce Manufacturers block');
        $this->description = $this->l('Displays a sliding block listing manufacturers and/or brands.');
    }
    ...
    public function getContent() {
        ...
        if( Tools::isSubmit('submitEcomBlockManufacturer') ){
    ...
    public function renderForm() {
        ...
        $helper->submit_action = 'submitEcomBlockManufacturer';
	...
	public function hookdisplayHeader($params){
		$this->context->controller->addCSS( ($this->_path).'assets/css/ecomblockmanufacturer.css', 'all');
        $this->context->controller->addCSS( ($this->_path).'assets/css/slick.css', 'all');

        $this->context->controller->addJS($this->_path.'assets/css/slick.min.js');
	}
    ...
    public function clearCache() {
    	$this->_clearCache( 'ecomblockmanufacturer.tpl' );
    }
